...
async fn main() {
    ...
    let app = Router::new()
        .route("/:lang/search", get(rest::search_recipe))
        .route("/:lang/recipe/:slug", get(rest::get_recipe))
        .route("/test", get(rest::get_challenge_form))
        .route("/test", post(rest::post_form))
